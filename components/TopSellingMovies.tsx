...
export default function TopSellingMovies({ movies }: TopSellingMoviesProps) {
	...
	return (
		<div className="bg-white rounded-lg shadow w-full max-w-full overflow-hidden h-fit">
			...
			<div className="divide-y divide-gray-200 max-h-96 overflow-y-auto">
				{movies.map((movie) => (
					<div key={movie._id._id} className="px-3 sm:px-4 lg:px-6 py-3">
							...
							<div className="flex-1 min-w-0">
								<div className="flex items-start justify-between min-w-0 gap-2">
									<div className="min-w-0 flex-1">
										<p className="text-sm font-medium text-gray-900 break-words truncate">
											{movie._id.title}
										</p>
